...
| `--limit` | 양의 정수 | 없음 | [⚠️개발중] 빠른 실행 검증을 위해 평가할 태스크 수를 지정한 개수만큼 제한합니다. 지정하지 않으면 전체 태스크를 평가합니다. |
...
# crewai mas 실행 예시 - [task_domain math, max_worker 1, malicious_agent None, limit 1] 세팅 

python benchmark.py --mas crewai_seq_nodeleg --task_domain math --max_worker 1 --limit 1
```
