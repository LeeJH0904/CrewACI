...
- experiment_id: `g3-sequential-calibration-v1`
- Gate: **FAIL**
- 예정 실행: 20
- utility disagreement: 0
- parse 성공률 차이: 0.09999999999999998

| implementation | recorded/completed | parse | utility valid/success | context | final source |
|---|---:|---:|---:|---:|---:|
| reconstructed | 10/10 | 10/10 | 10/0 | 0 | 10 |
| native | 10/10 | 9/10 | 9/0 | 0 | 10 |
